  ...
  document.addEventListener(
    ...
    function() {
      ...
      this.requestSync.addEventListener('click', () => {
        ...
        xhttp.open(
          'POST',
          'https://us-central1-smart-home-88eea.cloudfunctions.net/requestSync',
          true
        )
        xhttp.send()
      })
...
SmartHome.prototype.initWasher = () => {
  ...
  this.uid = '123'
  this.smarthome.userWelcome.innerHTML = 'Welcome user' + this.uid + '!'
...
SmartHome.prototype.handleData = () => {
  ...
  let elStartStopRunning = document.getElementById(
